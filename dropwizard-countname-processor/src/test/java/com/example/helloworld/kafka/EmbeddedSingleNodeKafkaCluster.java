...
import com.example.helloworld.zookeeper.ZooKeeperEmbedded;
...
public class EmbeddedSingleNodeKafkaCluster extends ExternalResource {
  ...
  public void start() throws Exception {
    ...
    //schemaRegistry = new RestApp(0, zookeeperConnect(), KAFKA_SCHEMAS_TOPIC, AVRO_COMPATIBILITY_TYPE,true);//remove props change in constructor
      schemaRegistry = new RestApp(0, zookeeperConnect(), KAFKA_SCHEMAS_TOPIC, AVRO_COMPATIBILITY_TYPE,schemaRegistryProps);//remove props change in constructor
